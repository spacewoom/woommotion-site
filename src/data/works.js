...
export const works = [
  // ✅ 예시 1개 (원하시면 여기처럼 계속 추가)
  {
    ...
    tags: ['인포그래픽', '모션그래픽'],
    summary: '텍스트를 최소화하고 직관적인 이미지 중심으로 구성해, 짧은 시간 안에 핵심 정보가 이해되도록 디자인했습니다.',
    info: {
      year: '2024',
      duration: '35s',
      role: '기획 · 디자인 · 애니메이션',
      // ✅ 이 값이 있어야 썸네일 클릭 시 모달이 열립니다
...
/**
 * ✅ 빌드 에러 해결 포인트: agency.astro에서 import 하는 makePlaceholders를 실제로 export!
 * - youtubeUrl을 빈 값으로 두면 썸네일 클릭해도 모달이 안 열리는(=정상) 상태가 됩니다.
 */
